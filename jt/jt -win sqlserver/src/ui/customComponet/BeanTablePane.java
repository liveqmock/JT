...
public class BeanTablePane<T> extends JPanel {
	...
	public BeanTablePane(Vector<T> beans,Class<T> class1) {
		this(beans,class1, null);
	}
	public BeanTablePane(Vector<T> beans,Class<T> class1,String[] headers) {
		this(beans,class1, headers,null);
	}

	public BeanTablePane(Vector<T> beans,Class<T> class1,String[] headers, String filterColoums[]) {
		super();
		this.beans = beans;
