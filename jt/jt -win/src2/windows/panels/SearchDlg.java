...
public class SearchDlg extends JDialog {
	...
	private BeanTablePane<Bill> tablePane;
	/**
	 * Create the panel.
	 */
	public SearchDlg(BeanTablePane<Bill> tablePane) {
	...
	private void doSearch() {
		...
		if(isLk.isSelected())
			sqlString+=" and itemComplete is not null ";
		tablePane.setBeans(Bill.loadBySearch(sqlString));
		this.dispose();
