...
public abstract class BeansPanel<T> extends BeanPanel<Vector<T>> {
	...
	public BeansPanel(Vector<T> beans, BeanPanel<T> beanPanel) {
		this(beans, beanPanel, null,false);
	}
	public BeansPanel(Vector<T> beans, BeanPanel<T> beanPanel,boolean vertical) {
		this(beans, beanPanel, null,vertical);
	}
	public BeansPanel(Vector<T> beans, BeanPanel<T> beanPanel,
			String filterColumns[]) {
		this(beans, beanPanel, filterColumns,false);
	}
	public BeansPanel(Vector<T> beans, BeanPanel<T> beanPanel,
