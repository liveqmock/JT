...
public class PicTable extends BeanTablePane<PicBean> {
	...
	private final static String[] admHeaders=new String[]{"客户","订单号","项目号","图号","客户订单号","数量","发货数量","不良数","最终报价(未含税)","最终报价(含税)","额定单件成本"
			,"总价","订单时间","客户要求交货时间","发货时间","开票金额","未开票金额","发票张数","最后开票日期",
			"特殊采用","特采客户确认人","特采确认人","外协单位","外协价格","外协数量","外协交货日期","外协发票数量","外协发票金额","外协发票时间","构件号","材料名","材料编号","材质","材料型号","材料技术条件","材料部件名"
			,"完成时间","入库","备注"};

	private final static String[] nomheaders=new String[]{"客户","订单号","项目号","图号","客户订单号","额定单件成本","数量","发货数量","不良数"
			,"订单时间","客户要求交货时间","发货时间","外协单位","外协价格","外协数量","外协交货日期","外协发票数量","外协发票金额","外协发票时间","构件号","材料名","材料编号"
			,"材质","材料型号","材料技术条件","材料部件名","完成时间","入库","备注"};
