 ...
 * @author Tim Boudreau
 */
final class NumberRangeE implements Validator<String> {
	private Number max;
	private Number min;

	NumberRangeE(Number min, Number max) {
		this.min = min;
		this.max = max;
	}
	...
	public boolean validate(Problems problems, String compName, String model) {
		try {
			...
			if (!result) {
				problems.add(NbBundle.getMessage(NumberRangeE.class,
						"VALUE_OUT_OF_RANGEE", new Object[] { // NOI18N
