...
public class OperCost extends BeanMao {
	...
	@ChinaAno(order=9,str="成品数")
	public int getProductNum() {
		return productNum;
	}
	@ChinaAno(order=10,str="报废数量")
	public int getScrapnum() {
		return scrapnum;
	}
	@ChinaAno(order=12,str="报废原因")
