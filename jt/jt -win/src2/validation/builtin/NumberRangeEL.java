 ...
 * @author Tim Boudreau
 */
final class NumberRangeEL implements Validator<String> {
	private Number max;
	private Number min;

	NumberRangeEL(Number min, Number max) {
		this.min = min;
		this.max = max;
	}
	...
	public boolean validate(Problems problems, String compName, String model) {
		try {
			...
			if (!result) {
				problems.add(NbBundle.getMessage(NumberRangeEL.class,
						"VALUE_OUT_OF_RANGEEL", new Object[] { // NOI18N
